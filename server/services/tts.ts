...
const MOOD_INSTRUCTIONS: Record<string, string> = {
  relaxed: 'Speak in a calm, easy, laid-back tone. Comfortable and natural.',
  ...
  excited: 'Speak with energy and enthusiasm. Animated and engaged.',
  annoyed: 'Speak with clipped irritation. Slightly terse.',
  frustrated: 'Speak with restrained frustration. Tense but controlled.',
  angry: 'Speak with sharp irritation. Direct and forceful.',
  sarcastic: 'Speak with dry sarcasm. Subtle edge, knowing tone.',
  thoughtful: 'Speak reflectively, a little contemplative. Natural pace, not rushed.',
  hesitant: 'Speak with a touch of uncertainty. Careful, feeling your way.',
  uncomfortable: 'Speak with slight awkwardness. A bit stilted, wanting to move on.',
  sad: 'Speak with quiet sadness. Subdued, a little withdrawn.',
  nostalgic: 'Speak with fond warmth. A little wistful, remembering.',
  ...
  surprised: 'Speak with genuine surprise. Caught off guard.',
  shocked: 'Speak with stunned disbelief. Taken aback.',
  embarrassed: 'Speak with flustered embarrassment. Wanting to deflect.',
  confident: 'Speak with assured confidence. Steady and direct.',
  passionate: 'Speak with conviction and intensity. Engaged and emphatic.',
  bored: 'Speak with flat disinterest. Disengaged, going through the motions.',
  sympathetic: 'Speak with gentle sympathy. Warm and caring.',
  skeptical: 'Speak with mild skepticism. Not quite buying it.',
  deadpan: 'Speak with dry, flat delivery. Understated.',
  wistful: 'Speak with gentle longing. Soft and reflective.',
  eager: 'Speak with bright eagerness. Ready and forward-leaning.',
  resigned: 'Speak with quiet acceptance. Matter-of-fact, not dramatic.',
  conspiratorial: 'Speak like you are sharing a secret. Quieter, leaning in.',
  teasing: 'Speak with warm, good-natured teasing. Playful ribbing.',
  intrigued: 'Speak with keen interest. Drawn in, wanting to know more.',
  animated: 'Speak with lively energy. Expressive and engaged.',
};
